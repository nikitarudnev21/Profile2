         ...
         <div class="row">
          <div class="col-md-6">
              <a href="${repos.html_url}" target="_blank">${repos.name}</a>
                ...
                <div class="col-md-6">
                    <span class="badg badge-primary:">Stars: ${repos.stargazers_count}</span>
                    <span class="badg badge-secondary:">Watchers: ${repos.watchers_count}</span>
                    <span class="badg badge-success:">Followers: ${repos.forks_count}</span>
